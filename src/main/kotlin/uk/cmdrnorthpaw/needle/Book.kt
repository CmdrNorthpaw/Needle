...
data  class Book(
    ...
    @SerializedName("filler_texture") val fillerTexture: ResourceLocation = ResourceLocation.EMPTY,
    @SerializedName("crafting_texture") val craftingTexture: ResourceLocation = ResourceLocation.EMPTY,
    ...
    @SerializedName("open_sound") val openingSound: ResourceLocation = ResourceLocation.EMPTY,
    @SerializedName("flip_sound") val pageFlipSound: ResourceLocation = ResourceLocation.EMPTY,
    @SerializedName("index_icon") val resourceLocation: ResourceLocation = ResourceLocation.EMPTY,
    ...
    @SerializedName("custom_book_item") val bookItem: ResourceLocation = ResourceLocation.EMPTY,
